...
drop table if exists streak_reward_definitions;
drop table if exists user_perk_unlocks;
drop table if exists level_perks;
drop table if exists perk_definitions;
drop table if exists user_quest_progress;
drop table if exists daily_quest_assignments;
drop table if exists daily_quest_pool;
drop table if exists level_quest_sets;
drop table if exists daily_quest_templates;
drop table if exists quest_templates;
drop table if exists saved_stickers;
drop table if exists billboard_placements;
drop table if exists sticker_assets;
drop table if exists billboards;
drop table if exists poi_daily_activations;
