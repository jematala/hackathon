export function createPOIElement(title: string): HTMLDivElement {
  const el = document.createElement("div");
  el.className = "poi-marker";
  el.innerHTML = `<div class="poi-marker-inner" title="${title}">
...
export function createBillboardElement(title: string): HTMLDivElement {
  const el = document.createElement("div");
  el.className = "billboard-marker";
  el.innerHTML = `<div class="billboard-marker-inner" title="${title}">
...
export function createUserAvatarElement(imageUrl: string, bgColor?: string): HTMLDivElement {
